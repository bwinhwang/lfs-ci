...
mustHaveNextCiLabelName 
execute tar -cv --transform=s:^\./:os/: -C ${WORKSPACE}/workspace/upload/ -f ${WORKSPACE}/workspace/KNIFE_LABEL.tgz --use-compress-program=/home/bm/projekte/work/nsn/ci.git/bin/pigz .
