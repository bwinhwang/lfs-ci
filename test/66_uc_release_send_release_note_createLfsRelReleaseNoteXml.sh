...
execute -n ${LFS_CI_ROOT}/bin/getReleaseNoteXML -t PS_LFS_REL_BUILD_NAME -o PS_LFS_REL_OLD_BUILD_NAME -T REL -P LFS -f ${LFS_CI_ROOT}/etc/lfs-ci.cfg -L pronb-developer
EOF
