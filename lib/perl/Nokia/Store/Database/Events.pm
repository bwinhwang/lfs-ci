...
sub newBuildEvent {
    ...
    my $dataHash      = { 
            ...
            target_install_failed       => $dataListShort,
            target_install_finished     => $dataListShort,
            target_install_started      => $dataListShort,
            target_reservation_failed   => $dataListShort,
            target_reservation_finished => $dataListShort,
            target_reservation_started  => $dataListShort,
            target_reboot_failed        => $dataListShort,
            target_reboot_finished      => $dataListShort,
            target_reboot_started       => $dataListShort,
