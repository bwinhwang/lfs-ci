...
getTaskNameFromJobName() {
    getFromString.pl "${JOB_NAME}" taskName
    return
}
...
getSubTaskNameFromJobName() {
    getFromString.pl "${JOB_NAME}" subTaskName
    return
}
...
getTargetBoardName() {
    getFromString.pl "${JOB_NAME}" platform
    return
}
...
getLocationName() {
    local location=$(getFromString.pl "${JOB_NAME}" location)
